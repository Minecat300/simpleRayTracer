...
function addMesh(arr, firstTriIndex, numTris, boundMin, boundMax, material = new Material()) {
    ...
    arr[i + 21] = material.specularProbability;
    arr[i + 22] = 0.0;
    arr[i + 23] = 0.0;
    arr[i + 24] = material.specularColor.r;
    arr[i + 25] = material.specularColor.g;
    arr[i + 26] = material.specularColor.b;
    arr[i + 27] = 0.0;
}
...
function addSphere(arr, center, radius = 1, material = new Material()) {
    ...
    arr[i + 13] = material.specularProbability; 
    arr[i + 14] = 0.0; 
    arr[i + 15] = 0.0;
    arr[i + 16] = material.specularColor.r; 
    arr[i + 17] = material.specularColor.g; 
    arr[i + 18] = material.specularColor.b;
    arr[i + 19] = 0.0; 
}
